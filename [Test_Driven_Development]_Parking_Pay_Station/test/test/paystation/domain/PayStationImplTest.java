 ...
 */
package test.paystation.domain; // added test. before paystation to fix error @ 1/31/2020
...
import paystation.domain.*; //added import for * to correct errors @ 1/31/2020
